(() => {
  ...
  const nav = active => `<div class="nw-top"><div class="nw-brand">NOVA</div><div class="nw-kicker">agentic os</div><nav class="nw-nav" aria-label="Nova"><a href="/">Orbit</a><a ${active==='mission'?'aria-current="page"':''} href="/mission">Mission</a><a ${active==='board'?'aria-current="page"':''} href="/board">Board</a><a ${active==='runs'?'aria-current="page"':''} href="/runs">Runs</a><a ${active==='vault'?'aria-current="page"':''} href="/vault">Vault</a><a href="/classic">Classic</a><a ${active==='agents'?'aria-current="page"':''} href="/agents">Agents</a></nav><div class="nw-status"><i class="nw-dot"></i>runtime online</div></div>`;
